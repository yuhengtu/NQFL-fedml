...
from fedml_api.standalone.fedavg_our.fedavg_api import FedAvgAPI
from fedml_api.standalone.fedavg_our.my_model_trainer_classification import MyModelTrainer as MyModelTrainerCLS
from fedml_api.standalone.fedavg_our.my_model_trainer_nwp import MyModelTrainer as MyModelTrainerNWP
from fedml_api.standalone.fedavg_our.my_model_trainer_tag_prediction import MyModelTrainer as MyModelTrainerTAG
...
if __name__ == "__main__":
    ...
    wandb.init(
        project="fedml",
        name="FedAVG_our-r" + str(args.comm_round) + "-e" + str(args.epochs) + "-lr" + str(args.lr),
        config=args
    )
