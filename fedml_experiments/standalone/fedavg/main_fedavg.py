...
# train/test_data_num：训练/测试数据集的样本数量
# train/test_data_global：全局训练/测试数据，中心节点集中式训练。
# train_data_local_num_dict：字典，客户端cid -> 客户端训练数据数量。
# train/test_data_local_dict：字典，客户端cid -> 客户端训练/测试数据
# class_num：分类问题中的类别数目
