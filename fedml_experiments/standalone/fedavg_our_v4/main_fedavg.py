...
from fedml_api.standalone.fedavg_our_v4.fedavg_api import FedAvgAPI
from fedml_api.standalone.fedavg_our_v4.my_model_trainer_classification import MyModelTrainer as MyModelTrainerCLS
from fedml_api.standalone.fedavg_our_v4.my_model_trainer_nwp import MyModelTrainer as MyModelTrainerNWP
from fedml_api.standalone.fedavg_our_v4.my_model_trainer_tag_prediction import MyModelTrainer as MyModelTrainerTAG
...
def load_data(args, dataset_name):
    ...
    if dataset_name == "mnist":
        ...
        class_num = load_partition_data_mnist(args.batch_size, args.partition_method)
        """
...
if __name__ == "__main__":
    ...
    wandb.init(
        project="fedml",
        name="FedAVG_our_v4-r" + str(args.comm_round) + "-e" + str(args.epochs) + "-lr" + str(args.lr) +
         "-dataset_" + str(args.dataset) + "-model_" + str(args.model) + "-dist_" + ("iid" if args.partition_method=='homo' else "noniid"),
        config=args
    )
