...
from fedml_api.standalone.fedavg_sk_nqfl.my_model_trainer_tag_prediction import MyModelTrainer as MyModelTrainerTAG
...
if __name__ == "__main__":
    ...
    wandb.init(
        project="fedml",
        # 变0
        name="FedAVG_Sk_nqfl-r" + str(args.comm_round) + "-e" + str(args.epochs) + 
